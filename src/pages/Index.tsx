    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <section className="section-spacing py-20 md:py-32 relative z-10">
        <div className="container-custom text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold gradient-title mb-8 leading-tight max-w-5xl mx-auto font-dm-serif">
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="p-8 bg-card/50 backdrop-blur-sm border-border/50 hover:bg-card/70 transition-all duration-300 text-left">
                ...
                <h3 className="text-xl md:text-2xl font-semibold gradient-title mb-4 font-dm-serif">Sistema de Aquisição de Clientes</h3>
              ...
              <Card className="p-8 bg-card/50 backdrop-blur-sm border-border/50 hover:bg-card/70 transition-all duration-300 text-left">
                ...
                <h3 className="text-xl md:text-2xl font-semibold gradient-title mb-4 font-dm-serif">Ativo Digital de Conversão</h3>
                <p className="text-foreground/70 leading-relaxed">
              ...
              <Card className="p-8 bg-card/50 backdrop-blur-sm border-border/50 hover:bg-card/70 transition-all duration-300 text-left">
                ...
                <h3 className="text-xl md:text-2xl font-semibold gradient-title mb-4 font-dm-serif">Inteligência de Atendimento e Vendas</h3>
                <p className="text-foreground/70 leading-relaxed">
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl md:text-2xl font-semibold gradient-title mb-4 font-dm-serif">Diagnóstico Estratégico</h3>
                <p className="text-foreground/70 leading-relaxed">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl md:text-2xl font-semibold gradient-title mb-4 font-dm-serif">Plano de Crescimento</h3>
                <p className="text-foreground/70 leading-relaxed">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl md:text-2xl font-semibold gradient-title mb-4 font-dm-serif">Execução e Escala</h3>
                <p className="text-foreground/70 leading-relaxed">
      ...
      <section className="section-spacing relative z-10">
        <div className="container-custom">
          <div className="max-w-6xl mx-auto text-center">
            ...
            {/* Logo Section */}
            <div className="mb-16">
              <h3 className="text-xl md:text-2xl font-semibold gradient-title mb-8 font-dm-serif">Empresas que confiam na Rise</h3>
            ...
            {/* Feedback Section */}
            <div className="mb-12">
              <h3 className="text-xl md:text-2xl font-semibold gradient-title mb-8 font-dm-serif">O que nossos clientes dizem</h3>
